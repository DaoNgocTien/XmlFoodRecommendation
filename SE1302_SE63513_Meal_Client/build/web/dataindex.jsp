...
//            }
            const pagination = page => {
                const domMaterial = localStorage.getItem("DOMMATERIAL");

                alert(page);
                document.querySelector('#txtPage').value += page;
            };


            //  Get List Food and List Material from database, then redirect to homepage
            const saveData = () => {
                const listFood = localStorage.getItem("LISTFOOD");
                const domMaterial = localStorage.getItem("DOMMATERIAL");
...
//                if (localStorage.getItem("LISTFOOD") || localStorage.getItem("DOMMATERIAL")) {
//                    window.location.href = "http://localhost:8084/SE1302_SE63513_Meal_Client/index.jsp";
//                }
            };
        ...
        <div class="w3-sand w3-grayscale w3-large">
            ...
            <div class="w3-container" id="menu">
                ...
                <div class="w3-content" style="max-width:700px">
                    ...
                    <div class="w3-row w3-center w3-card w3-padding"  id="myLink" onclick="openMenu('myLink', 'searchIngredient');">
                        <input style="width: 80%;color:#a94442 " type="text" placeholder="What do you search for" />
                    </div>

                    <div id="searchIngredient" class="w3-container menu w3-padding-48 w3-card" style="display: none">
                        ...
                        <!-- Phân trang -->
                        <div class="w3-center w3-padding-28">
                            <div class="w3-bar">
                                <a onclick="pagination(document.querySelector('#txtPage').value);" class="w3-bar-item w3-button w3-hover-pink">«</a>
                                <!--<a href="#" class="w3-bar-item w3-black w3-button">1 of 27</a>-->
                                <input type="hidden" name="txtPage" id="txtPage" value="1" />
                                <a class="w3-bar-item w3-button w3-hover-pink">1 of 27</a>
                                <a onclick="pagination(document.querySelector('#txtPage').value);"  class="w3-bar-item w3-button w3-hover-pink">»</a>
                            </div>
                        </div>
                    </div> 
